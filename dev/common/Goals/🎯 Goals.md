...
/* ── PAUSE §4 — writes. Line-based frontmatter (setFm is the same routine as in
      dashboard/initHub.js) + the Timeline's exact-match line resolution. ── */
...
/* ═══ ADDTASK §1 — the note a "＋ Task" writes ════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════════════════ */
const NOUN = "task", NOUNC = "Task";          /* a variant may rename the noun */
